...
export const getUserProjects = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    if (projects.length === 0) {
      console.log('No projects found for user, returning mock data for testing');
...
export const getUserApplications = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    if (applications.length === 0) {
      console.log('No applications found for user, returning mock data for testing');
          ...
          applications: [
            {
              ...
              project: {
                ...
                description: 'This is a mock project application for testing the dashboard'
              }
            },
            {
