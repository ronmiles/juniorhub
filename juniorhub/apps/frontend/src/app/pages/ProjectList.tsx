              ...
              {projects.map((project: any) => (
                <div key={project.id} className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <div className="mt-4 text-sm text-gray-500">
                    <span>
                      Timeline: {new Date(project.timeframe.startDate).toLocaleDateString()} - {new Date(project.timeframe.endDate).toLocaleDateString()}
                    </span>
                  </div>
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      <span className="text-sm text-gray-500">
                        <i className="far fa-user"></i> {project.applicants?.length || 0} applicants
                      </span>
                      <span className="text-sm text-gray-500">
                        <i className="far fa-heart"></i> {project.likes || 0} likes
                      </span>
                    </div>
                    <Link
                      to={`/projects/${project.id}`}
